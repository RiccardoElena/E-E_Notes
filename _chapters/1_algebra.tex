...
\begin{observation}[label=obs:power_notation]{}
...
% FIXME SI
\todo{Chiedere a De Luca se \((\N,+)\) è libero di base \(\set{1}\), se no perché? SI,}
...
\end{observation}
% FIXME 
% su A = a,b tutte le parole che non contengono bbb
