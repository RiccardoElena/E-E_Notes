...
Questo semigruppo (o monoide) delle parti è particolarmente rilevante, poiché, grazie alle notazioni introdotte nella \Cref{note:power_notation}, è possibile definire le potenze di un qualsiasi sottoinsieme \(Y \subseteq S\).
...
\begin{proof}[\warningsymbol{} Idea di dimostrazione]\label{proof:alt_notation_closure}
...
\end{proposition}
\begin{proof}[\warningsymbol{} Idea di dimostrazione]
