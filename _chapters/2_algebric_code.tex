...
\begin{theorem}[Disuguaglianza di Kraft-McMillan]\label{thm:kraft-mcmillan_inequality}
...
A questo punto, possiamo riscrivere la Disuguaglianza di Kraft-McMillan (\ref{thm:kraft-mcmillan_inequality}) come:
\begin{theorem}[Disuguaglianza di Kraft-McMillan alt.]\label{thm:kraft-mcmillan_inequality_alt}
  Dato \(X \subseteq A^+\), con \(\# A = d\), si ha:
...
Inoltre, una distribuzione su un alfabeto \(A\) è detta \keyword{uniforme} se \(\forall a \in A, \mu(a) = \frac{1}{\# A}\).
...
\begin{proposition}
  ...
  \[X \text{ codice } \iff \forall n \geq 1, X\times X^n \text{ è non ambiguo}\]
\end{proposition}
\begin{proof}
